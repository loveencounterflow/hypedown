...
#-----------------------------------------------------------------------------------------------------------
@pg_and_hd_tags =
  otag:       { type: 'o_ltr',    open: true,  close: false, parse: true, }  # opening tag, `<t>`
  ctag:       { type: 'c_lstr',   open: false, close: true,  parse: true, }  # closing tag, `</t>` or `</>`
  ntag:       { type: 'o_lts',    open: true,  close: false, parse: true, }  # opening tag of `<t/italic/`
