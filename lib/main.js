(function() {
  'use strict';
  var $, DATOM, E, GUY, Hypedown_lexer, Hypedown_parser, Hypedown_transforms, Hypedown_transforms_stars, Interlex, Markdown_sx, Pipeline, Standard_sx, Syntax, XXX_new_token, alert, compose, debug, echo, get_base_types, help, info, inspect, lets, log, misfit, new_datom, plain, praise, rpr, select_token, stamp, transforms, urge, warn, whisper;
  ...
  Hypedown_transforms = class Hypedown_transforms extends Hypedown_transforms_stars {
    ...
    $generate_p_tags()/* needs add_parbreak_markers, capture_text */ {
      ...
      * https://stackoverflow.com/questions/8460993/p-end-tag-p-is-not-needed-in-html
       ...
       */
      var generate_p_tags, html_text_lx, p, parbreak_lx, window;
      ...
      p.push(generate_p_tags = function([prv, d, nxt], send) {
