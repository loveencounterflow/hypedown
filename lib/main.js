(function() {
  'use strict';
  var GUY, Hypedown_lexer, Hypedown_parser, Interlex, Markdown_sx, Standard_sx, Syntax, XXX_new_token, alert, compose, debug, echo, help, info, inspect, log, plain, praise, rpr, urge, warn, whisper;
