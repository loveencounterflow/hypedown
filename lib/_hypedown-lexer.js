(function() {
  'use strict';
  var DATOM, E, GUY, Hypedown_lexer, Interlex, Markdown_sx, Standard_sx, Syntax, _TEMP_add_lexemes, alert, compose, debug, echo, get_base_types, help, info, inspect, lets, log, misfit, new_datom, plain, praise, rpr, stamp, urge, warn, whisper;
  ...
  _TEMP_add_lexemes = function(lexer) {
    var new_escchr_descriptor, new_nl_descriptor;
