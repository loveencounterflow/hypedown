(function() {
  ...
  Markdown_sx = (function() {
    ...
    class Markdown_sx extends Syntax {
      ...
      static lx_variable_codespan(cfg) {
        var backtick_count, entry_handler, exit_handler, jump_codespan;
        backtick_count = null;
        jump_codespan = `${this.cfg.codespan_mode}[`;
        //.......................................................................................................
        ...
        return [
          ...
          new_nl_descriptor(this.cfg.codespan_mode),
          new_escchr_descriptor(this.cfg.codespan_mode),
          {
  ...
  new_escchr_descriptor = function(mode) {
    ...
    create = function(token) {
      var ref;
      if (((ref = token.atrs) != null ? ref.chr : void 0) == null) {
        token.atrs = {
          chr: '\n'
        };
      }
