(function() {
  'use strict';
  var DATOM, E, GUY, H, Pipeline_module, alert, debug, echo, help, info, inspect, lets, log, new_datom, plain, praise, rpr, sorter, stamp, urge, warn, whisper;
  ...
  //===========================================================================================================
  this.Hypedown_parser_md_stars = class Hypedown_parser_md_stars extends Pipeline_module {
    //-----------------------------------------------------------------------------------------------------------
    $parse_md_stars() {
      var enter, exit, parse_md_stars, star1_mk, star2_mk, star3_mk, token_for, within;
...
//# sourceMappingURL=_hypedown-parser-stars.js.map