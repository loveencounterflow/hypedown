(function() {
  'use strict';
  var DATOM, E, GUY, H, Transformer, alert, debug, echo, help, info, inspect, lets, log, new_datom, plain, praise, rpr, sorter, stamp, urge, warn, whisper;
  ...
  //===========================================================================================================
  this.Hypedown_parser_md_stars = class Hypedown_parser_md_stars extends Transformer {
    //-----------------------------------------------------------------------------------------------------------
    $parse_md_stars() {
