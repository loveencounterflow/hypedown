(function() {
  ...
  this.Hypedown_transforms_stars = class Hypedown_transforms_stars {
    //---------------------------------------------------------------------------------------------------------
    $parse_md_stars() {
      var enter, exit, ordering_is, star1_mk, star2_mk, star3_mk, start_of, within;
      debug('^646456^', this);
      process.exit(111);
      ({ordering_is} = this.lexer.sorter);
      ...
      return function(d, send) {
        switch (d.mk) {
          ...
          case star2_mk:
            ...
            if (within.two) {
              if (within.one) {
                if (ordering_is(start_of.two, start_of.one)) {
                  exit.one();
          ...
          //...................................................................................................
          case star3_mk:
            debug('^423342^', 'star3', within.one, within.two, start_of.one, start_of.two);
            send(stamp(d));
            if (within.one) {
              if (within.two) {
