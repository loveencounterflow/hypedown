(function() {
  'use strict';
  var $, DATOM, GUY, HTMLISH, Pipeline, Pipeline_module, TR, alert, debug, echo, help, info, inspect, lets, log, new_datom, plain, praise, ref, rpr, stamp, transforms, urge, warn, whisper,
  ...
  //-----------------------------------------------------------------------------------------------------------
  ref = this.Hypedown_parser_htmlish = class Hypedown_parser_htmlish extends Pipeline_module {
    constructor() {
      super(...arguments);
      // #---------------------------------------------------------------------------------------------------------
      // $parse_htmlish: ->
      ...
      //---------------------------------------------------------------------------------------------------------
      this.$normalize_tag_tokens = this.$normalize_tag_tokens.bind(this);
      //---------------------------------------------------------------------------------------------------------
      this.$collect_tag_tokens = this.$collect_tag_tokens.bind(this);
      //---------------------------------------------------------------------------------------------------------
      this.$parse_tag_source = this.$parse_tag_source.bind(this);
      //---------------------------------------------------------------------------------------------------------
      this.$parse_sole_slash = this.$parse_sole_slash.bind(this);
    }
    ...
    _hd_token_from_paragate_token(hd_token, pg_token) {
      ...
      if (pg_token.$key === '^pi') {
        ...
        if ((tid = (ref1 = TR.pg_and_hd_tags[pg_token.type]) != null ? ref1.type : void 0) == null) {
    ...
    $collect_tag_tokens() {
      ...
      return _collect_tag_tokens = (d, send) => {
        var first_token, i, len, ref1, ref2, ref3, t, token;
        if (d.tid === '$border') {
          //...................................................................................................
          if (d.data.nxt === 'tag') {
            send(d);
          ...
          //...................................................................................................
            ...
            if ((collector.length === 1) && !((ref1 = (ref2 = (first_token = collector[0])) != null ? (ref3 = ref2.data) != null ? ref3.parse : void 0 : void 0) != null ? ref1 : true)) {
              collector = null;
