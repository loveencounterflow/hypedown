(function() {
  'use strict';
  var $, DATOM, GUY, HTMLISH, Pipeline, TR, Transformer, alert, debug, echo, help, info, inspect, lets, log, new_datom, plain, praise, rpr, stamp, transforms, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.Hypedown_parser_htmlish = class Hypedown_parser_htmlish extends Transformer {
    //---------------------------------------------------------------------------------------------------------
