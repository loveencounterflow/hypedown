(function() {
  'use strict';
  var DATOM, GUY, HTMLISH, Pipeline, alert, debug, echo, help, info, inspect, lets, log, new_datom, plain, praise, rpr, stamp, transforms, urge, warn, whisper,
    ...
    return _class = (function() {
      ...
      _Class = class extends clasz {
        ...
        _hd_token_from_paragate_token(hd_token, pg_token) {
          var R, ref, ref1, tid;
          //.......................................................................................................
          tid = pg_token.$key === '^error' ? '$error' : (ref = (ref1 = this.tag_types[pg_token.type]) != null ? ref1.type : void 0) != null ? ref : '???';
          R = {
            mode: 'tag',
            tid: tid,
            jump: null,
        ...
        $_collect_tag_tokens() {
          ...
          return _collect_tag_tokens = (d, send) => {
            var first_token, i, len, ref, t, token;
            if (d.tid === '$border') {
              //...................................................................................................
              if (d.data.nxt === 'tag') {
                send(d);
              ...
              //...................................................................................................
                ...
                if (((ref = (first_token = collector[0])) != null ? ref.mk : void 0) === 'tag:c_lsr') {
                  collector = null;
