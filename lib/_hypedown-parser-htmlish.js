(function() {
  'use strict';
  var GUY, HTMLISH, Pipeline, alert, debug, echo, help, htmlish_sym, info, inspect, log, new_parser, plain, praise, rpr, transforms, urge, warn, whisper;
