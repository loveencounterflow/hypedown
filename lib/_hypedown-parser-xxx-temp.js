(function() {
  'use strict';
  var $, DATOM, E, GUY, H, Hypedown_lexer, Pipeline, Pipeline_module, alert, debug, echo, get_base_types, help, info, inspect, lets, log, misfit, new_datom, plain, praise, rpr, stamp, transforms, urge, warn, whisper;
  ...
  this.$010_prepare_paragraphs = class $010_prepare_paragraphs extends Pipeline_module {
    ...
    $add_parbreak_markers()/* needs inject_virtual_nl */ {
      var mk, newline_mk, p, template, window;
      newline_mk = 'plain:nl';
      mk = 'html:parbreak';
      p = new Pipeline();
      template = {
      ...
      p.push(function(ds, send) {
        ...
        for (i = 0, len = ds.length; i < len; i++) {
          d = ds[i];
          help('^3242^', (ref = d != null ? d.mk : void 0) != null ? ref : '---');
        }
        return send(ds.at(3));
      });
      p.push(window = transforms.$window({
      ...
      p.push(function(ds) {
        ...
        for (i = 0, len = ds.length; i < len; i++) {
          d = ds[i];
          results.push(urge('^3242^', (ref = d != null ? d.mk : void 0) != null ? ref : '---'));
        }
        return results;
      });
      p.push(function(ds, send) {
  ...
  //===========================================================================================================
  this.$020_priority_markup = class $020_priority_markup extends Pipeline_module {
...
//.....................................................................................................
  ...
  //===========================================================================================================
  this.$050_hash_headings = class $050_hash_headings extends Pipeline_module {
    $() {
