(function() {
  ...
  this.$020_priority_markup = class $020_priority_markup extends Transformer {
    ...
    $parse_md_codespan() {
      ...
      var collector, enter_mk, escchr_mk, exit_mk, flush, parse_md_codespan, stop, text_mk;
...
//.....................................................................................................
        for (idx = i = 0, len = collector.length; i < len; idx = ++i) {
          d = collector[idx];
          urge('^flush^', d.mk, rpr(d.value), idx === 0, idx === last_idx);
          if (idx === 0) {
            yield stamp(d);
      ...
      return parse_md_codespan = $({stop}, function(d, send) {
        ...
        debug('^34^', d);
        debug('^34^', (ref1 = d.mk) != null ? ref1 : '??', rpr((ref2 = d.value) != null ? ref2 : '??'));
        if (d === stop) {
          ref3 = flush();
          for (e of ref3) {
            send(e);
